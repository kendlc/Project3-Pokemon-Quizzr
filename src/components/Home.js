  ...
  return (
    <Container>
      <Row className="mx-auto">
        <Col
          sm
          className="mt-5 d-flex justify-content-lg-end justify-content-center"
        >
          <img
        ...
        <Col className="mt-5 text-sm-left">
          ...
          <p
            ...
            style={{ fontSize: "18px", color: "gray" }}
          >
            Climb your way to the top through the <strong>POKEDEX</strong> where
            you can study all 1025 pokemons!
          </p>
          <p
            className="text-sm-left mb-4"
            style={{ fontSize: "18px", color: "gray" }}
      ...
      <Container>
        <Row className="mt-5">
          <h4 style={{ color: "gray" }}>Featured Pokemon</h4>
